...
Public Class frmClientes
    ...
    Private Sub PonerDatos()
        ...
        If Not CBool(row.Item("Activo")) Then
            If MessageBoxEx.Show("El cliente está desactivado ¿Desea activarlo?", "Confirmación", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
    ...
    Public Sub Eliminar()
        If MessageBoxEx.Show("¿Está seguro que desea eliminar al cliente?" & vbNewLine & "Sí realiza la operación el cliente " & _
